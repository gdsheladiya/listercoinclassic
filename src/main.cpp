...
unsigned int nTargetSpacing = 30 * 24 * 60 * 60; // 30 days 
unsigned int nStakeMinAge = 90 * 24 * 60 * 60; // 90 days 
...
const string strMessageMagic = "LTC Classic Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LTC Classic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "LTC Classic is here ! ... ";
        CTransaction txNew;
        txNew.nTime = 1513628653;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513628653;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1894549;
...
// This will figure out a valid hash and Nonce if you're
        ...
        //// debug print
        ///
        assert(block.hashMerkleRoot == uint256("0x1b19330923a86a85c459e84de907067fc80a5607b9eb92a8326e925d63dd7ebc"));
        block.print();

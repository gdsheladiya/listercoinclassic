...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("LTC Classic-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LTC Classic " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
       ...
       {"128.199.204.44", "128.199.204.44"},
       {"139.59.44.99", "139.59.44.99"},
       {"128.199.84.190", "128.199.84.190"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("LTC Classic-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("LTC Classic-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("LTC Classic-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("LTC Classic-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LTC Classic is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("LTC Classic-start");
